...
class AuthManager {
    ...
    updateNavigation() {
        ...
        if (this.currentUser) {
            ...
            // User is not logged in - show compact Google sign-in button
            navAuth.innerHTML = `
                <div class="auth-buttons">
                    <button onclick="authManager.signInWithGoogle()" class="google-signin-btn compact">
            ...
            // Update mobile navigation for non-logged in users
            if (navAuthMobile) {
                navAuthMobile.innerHTML = `
